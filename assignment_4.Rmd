...
The table that morris recived shows the mean for growth to be 2.46
...
#rgdp60 is the value of GDP per capita in 1960, converted to 1960 US dollars. the purpose of this could be to see if a country was already "developed". since a developed country would show less growth from 1965 to 1995 than a country with a lower GDP per capita that is still in devlopment. thus being an explanation for a lower growth rate.
